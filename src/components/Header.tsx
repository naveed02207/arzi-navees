        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center bg-white/10 rounded-lg p-1 border border-white/20 ">
            ...
            <select
              ...
              className="bg-transparent text-sm font-semibold text-white focus:outline-none cursor-pointer px-1"
            >
              {" "}
          ...
          <button
            onClick={onOpenGuide}
            className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white bg-white/10 hover:bg-emerald-100 :bg-white/10 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
          ...
          <button
            ...
            className="md:hidden relative flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white bg-white/10 border border-white/20 hover:bg-white/10 :bg-white hover:shadow-md transition-all duration-300 hover:-translate-y-0.5"
          >
            {" "}
            <History className="w-4 h-4 text-white " />{" "}
            <span className="hidden sm:inline">History</span>{" "}
            {historyCount > 0 && (
              <span className="ml-1 px-2 py-0.5 text-xs rounded-full bg-teal-500 text-white font-bold">
                {" "}
                {historyCount}{" "}
              </span>
            )}{" "}
          ...
          <button className="flex items-center gap-2 text-white hover:text-white :text-emerald-400 transition-colors">
            {" "}
